...
import 'package:khanyi_vending_app/model/user_model.dart';
...
class DataFile {
  ...
  static List<IncidentModel> incidentHistory = [
    IncidentModel(
      ...
      "Token not received",
      "High",
      "Purchased R100 electricity but token was not delivered to my phone. Transaction reference: KV001234567890",
      DateTime.now().subtract(Duration(days: 1)),
      "Resolved",
      "Token has been resent to your phone. Please check your SMS.",
    ),
    IncidentModel(
      "INC87654321",
      "Mary Smith",
      ...
      "Critical",
      "My prepaid meter is rejecting the electricity token. Error code 30 appears on display.",
      DateTime.now().subtract(Duration(days: 3)),
      "In Progress",
      "Technician has been dispatched to your location. ETA: 2 hours",
    ),
    IncidentModel(
      "INC11223344",
      "Peter Johnson",
      ...
      "Medium",
      "Was charged R150 but only received R100 worth of electricity units.",
      DateTime.now().subtract(Duration(days: 5)),
      "Resolved",
      "Refund of R50 has been processed and will reflect in 2-3 business days.",
    ),
    IncidentModel(
      "INC55667788",
      "Sarah Wilson",
      ...
      "High",
      "Payment was deducted from my bank account but no electricity token was generated.",
      DateTime.now().subtract(Duration(days: 7)),
      "Resolved",
      "Transaction has been reversed and electricity token generated: 12345-67890-12345-67890",
    ),
    IncidentModel(
      "INC99887766",
      "Tom Brown",
      ...
      "Low",
      "App keeps crashing when I try to select my residential complex.",
      DateTime.now().subtract(Duration(days: 10)),
      "Pending",
      "We are investigating this issue. Please try updating the app to the latest version.",
    ),
  ];
