...
import 'package:khanyi_vending_app/util/country_code_picker.dart';
  ...
  return TextFormField(
    ...
    decoration: InputDecoration(
        ...
        prefixIcon: prefix
            ...
            : getHorSpace(16.h),
        suffixIcon: suffix
            ? getSvgImage(suffixImage!, width: 24.h, height: 24.h)
                .paddingSymmetric(horizontal: 16.h)
            : getHorSpace(16.h),
        prefixIconConstraints: BoxConstraints(maxHeight: 24.h, maxWidth: 110.h),
        suffixIconConstraints: suffix
            ? BoxConstraints(maxHeight: 24.h, maxWidth: 60.h)
            : BoxConstraints(maxWidth: 0),
        filled: true,
